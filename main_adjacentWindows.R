  ...
  ggsave("figures/finalFiguresAndTables/Figure3.pdf", plot = last_plot(), width = 9, height = 6.5, units = "in")
  ...
  ggsave("figures/finalFiguresAndTables/Figure6.pdf", plot = last_plot(),  width = 9, height = 7, units = "in")
  ...
  ggsave("figures/finalFiguresAndTables/Figure7.pdf", plot = last_plot(),  width = 9, height = 7, units = "in")
  ...
  ggsave("figures/finalFiguresAndTables/Figure4.pdf",plot = last_plot(),  width = 9, height = 6.5, units = "in")
  ...
  ggsave("figures/finalFiguresAndTables/Figure5.pdf",plot = last_plot(),  width = 9, height = 6.5, units = "in")
  ...
  ## Finally, compre LAC to benchmarks
...
#  print(LACvsAfrica,"figures/tables/LACgrowthDecomposition_benchmark_Africa.tex", caption.placement = "top", type = "latex",  booktabs = TRUE, include.rownames = FALSE, size = "\\footnotesize")
  ...
  regResults <- fread("figures/tables/sec2_mainReg_timeDummies_LACinteractionsAll_nonlagGap.csv")
  regResults2 <- fread("figures/tables/sec2_mainReg_noCountryRegionDummies.csv")
  ...
  constant <- regResults[11]
  constant <- constant[ , .(V2,V3,V4)]
  
  constant2 <- regResults2[10]
  ...
  # Write to excel
  write.xlsx(LACvsnonLAC,"figures/tables/excel/LACvsNONLAC_gapControlled.xlsx")
  ...
  kable(LACvsnonLAC, "latex", booktabs = T, digits = 2, linesep = "", caption = "LAC per capita output growth gap: non-LAC benchmark") %>% kable_styling(full_width = F, latex_options = c("hold_position")) %>% 
    column_spec(2:10, width = "1.75cm") %>% pack_rows("Averages",nrow(LACvsnonLAC)-2,nrow(LACvsnonLAC)) %>% landscape() %>% cat(., file = "figures/tables/LACvsNONLAC_gapControlled.tex") 
  ...
  # Write to excel
  write.xlsx(LACvsEAT,"figures/tables/excel/LACvsEAT_gapControlled.xlsx")
  ...
  kable(LACvsEAT, "latex", booktabs = T, digits = 2, linesep = "", caption = "LAC per capita output growth gap: EAT benchmark") %>% kable_styling(full_width = F, latex_options = c("hold_position")) %>% 
    column_spec(2:10, width = "1.75cm") %>% pack_rows("Averages",nrow(LACvsEAT)-2,nrow(LACvsEAT)) %>% landscape() %>% cat(., file = "figures/tables/LACvsEAT_gapControlled.tex") 
  ...
  # Write to excel
  write.xlsx(LACvsAFR,"figures/tables/excel/LACvsAFR_gapControlled.xlsx")
  ...
  kable(LACvsAFR, "latex", booktabs = T, digits = 2, linesep = "", caption = "LAC per capita output growth gap: AFR benchmark") %>% kable_styling(full_width = F, latex_options = c("hold_position")) %>% 
    column_spec(2:10, width = "1.75cm") %>% pack_rows("Averages",nrow(LACvsAFR)-2,nrow(LACvsAFR)) %>% landscape() %>% cat(., file = "figures/tables/LACvsAFR_gapControlled.tex") 
  ...
  # Write to excel
  write.xlsx(LACvsUSA,"figures/tables/excel/LACvsUSA_gapControlled.xlsx")
  ...
  kable(LACvsUSA, "latex", booktabs = T, digits = 2, linesep = "", caption = "LAC per capita output growth gap: USA benchmark") %>% kable_styling(full_width = F, latex_options = c("hold_position")) %>% 
    column_spec(2:10, width = "1.75cm") %>% pack_rows("Averages",nrow(LACvsUSA)-2,nrow(LACvsUSA)) %>% landscape() %>% cat(., file = "figures/tables/LACvsUSA_gapControlled.tex") 
  ...
  ggsave("figures/rtfpnaGrowth_LAC_ActualVsPredicted.pdf", plot = last_plot())
  ...
  ggsave("figures/nonrtfpnaGrowth_LAC_ActualVsPredicted.pdf", plot = last_plot())
  ...
  ggsave("figures/rgdpnaGrowth_LAC_ActualVsPredicted.pdf", plot = last_plot())
...
data <- fread("figures/tables/sec2_mainReg_LACCountryDummies_PrePost_clean.csv")
...
#ggsave("figures/finalFiguresAndTables/Figure8.pdf",  width = 9, height = 6.5, units = "in")
...
ggsave("figures/LAC_post1990leaders_compared_to_USA.pdf",plot = last_plot(), width = 9, height = 6.5, units = "in")
...
dummies <- fread("figures/tables/sec2_mainReg_LACCountryDummies.csv")
...
ggsave("figures/LAC_Country_Dummmies_Decomposition.pdf",plot = last_plot(), width = 9, height = 6.5, units = "in")
