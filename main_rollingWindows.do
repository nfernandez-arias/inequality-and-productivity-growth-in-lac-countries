...
esttab using "figures/tables/sec3_mainReg_noCountryRegionDummies_rollingWindows.tex", se star(* 0.1 ** 0.05 *** 0.01) drop(_cons *.year) label replace compress substitute(\_ _ {table} {sidewaystable}) addnote("\textbf{Regression equation:} \(g_{it} = \alpha + \gamma_t + \beta \big(\log (\frac{\textrm{cgdpo}_{it}}{\textrm{pop}_{it}} ) - \log (\frac{\textrm{cgdpo}_{USA,t}}{\textrm{pop}_{USA,t}}  ) \big) + \epsilon_{it}\)") wrap style(tex) title(Growth dynamics worldwide) b(a2)
...
esttab using "figures/tables/sec3_mainReg_noCountryRegionDummies_ginimktSquared_rollingWindows.tex", se star(* 0.1 ** 0.05 *** 0.01) drop(_cons *.year) label replace compress substitute(\_ _ {table} {sidewaystable}) addnote("\textbf{Regression equation:} \(g_{it} = \alpha + \gamma_t + \beta \big(\log (\frac{\textrm{cgdpo}_{it}}{\textrm{pop}_{it}} ) - \log (\frac{\textrm{cgdpo}_{USA,t}}{\textrm{pop}_{USA,t}}  ) \big) + \epsilon_{it}\)") wrap style(tex) title(Growth dynamics worldwide) b(a2)
...
esttab using "figures/tables/sec3_mainReg_noCountryRegionDummies_horseRace_rollingWindows.tex", se star(* 0.1 ** 0.05 *** 0.01) drop(_cons *.year) label replace compress substitute(\_ _ {table} {sidewaystable}) addnote("\textbf{Regression equation:} \(g_{it} = \alpha + \gamma_t + \beta \big(\log (\frac{\textrm{cgdpo}_{it}}{\textrm{pop}_{it}} ) - \log (\frac{\textrm{cgdpo}_{USA,t}}{\textrm{pop}_{USA,t}}  ) \big) + \epsilon_{it}\)") wrap style(tex) title(Growth dynamics worldwide) b(a2)
...
esttab using "figures/tables/sec3_mainReg_onlyLACdummy_rollingWindows.tex", se label star(* 0.1 ** 0.05 *** 0.01) replace compress substitute(\_ _ {table} {sidewaystable}) addnote("\textbf{Regression equation:} \(g_{it} = \alpha + \sigma \mathbf{1}_{\textrm{LAC}} + \gamma_t + \beta \big(\log (\frac{\textrm{cgdpo}_{it}}{\textrm{pop}_{it}} ) - \log (\frac{\textrm{cgdpo}_{USA,t}}{\textrm{pop}_{USA,t}}  ) \big) + \epsilon_{it}\)") wrap style(tex) title(Statistical significance of LAC growth gap (Non-LAC Benchmark)) booktabs b(a2)
...
esttab using "figures/tables/sec3_mainReg_onlyLACdummy_giniSquared_rollingWindows.tex", se label star(* 0.1 ** 0.05 *** 0.01) replace compress substitute(\_ _ {table} {sidewaystable}) addnote("\textbf{Regression equation:} \(g_{it} = \alpha + \sigma \mathbf{1}_{\textrm{LAC}} + \gamma_t + \beta \big(\log (\frac{\textrm{cgdpo}_{it}}{\textrm{pop}_{it}} ) - \log (\frac{\textrm{cgdpo}_{USA,t}}{\textrm{pop}_{USA,t}}  ) \big) + \epsilon_{it}\)") wrap style(tex) title(Statistical significance of LAC growth gap (Non-LAC Benchmark)) booktabs b(a2)
...
esttab using "figures/tables/sec3_mainReg_onlyLACdummy_ginimkt_rollingWindows.tex", se label star(* 0.1 ** 0.05 *** 0.01) replace compress substitute(\_ _ {table} {sidewaystable}) addnote("\textbf{Regression equation:} \(g_{it} = \alpha + \sigma \mathbf{1}_{\textrm{LAC}} + \gamma_t + \beta \big(\log (\frac{\textrm{cgdpo}_{it}}{\textrm{pop}_{it}} ) - \log (\frac{\textrm{cgdpo}_{USA,t}}{\textrm{pop}_{USA,t}}  ) \big) + \epsilon_{it}\)") wrap style(tex) title(Statistical significance of LAC growth gap (Non-LAC Benchmark)) booktabs b(a2)
...
esttab using "figures/tables/sec3_mainReg_onlyLACdummy_horseRace_rollingWindows.tex", se label star(* 0.1 ** 0.05 *** 0.01) replace compress substitute(\_ _ {table} {sidewaystable}) addnote("\textbf{Regression equation:} \(g_{it} = \alpha + \sigma \mathbf{1}_{\textrm{LAC}} + \gamma_t + \beta \big(\log (\frac{\textrm{cgdpo}_{it}}{\textrm{pop}_{it}} ) - \log (\frac{\textrm{cgdpo}_{USA,t}}{\textrm{pop}_{USA,t}}  ) \big) + \epsilon_{it}\)") wrap style(tex) title(Statistical significance of LAC growth gap (Non-LAC Benchmark)) booktabs b(a2)
...
esttab using "figures/tables/sec3_mainReg_LACdummy_PrePost_horseRace_rollingWindows.tex", se label star(* 0.1 ** 0.05 *** 0.01) replace compress substitute(\_ _ {table} {sidewaystable}) addnote("\textbf{Regression equation:} \(g_{it} = \alpha + \sigma_1 \mathbf{1}_{\textrm{LAC,pre1990}} + \sigma_2 \mathbf{1}_{\textrm{LAC,post1990}} + \gamma_t + \beta \big(\log (\frac{\textrm{cgdpo}_{it}}{\textrm{pop}_{it}} ) - \log (\frac{\textrm{cgdpo}_{USA,t}}{\textrm{pop}_{USA,t}}  ) \big) + \epsilon_{it}\)") wrap style(tex) title(Statistical significance of LAC growth gap, pre- and post-1990 (Non-LAC Benchmark)) booktabs b(a2)
eststo clear
...
esttab using "figures/tables/sec3_mainReg_LACCountryDummies_rollingWindows.tex", label star(* 0.1 ** 0.05 *** 0.01) replace compress drop(*year) nobaselevels nogaps not noparentheses substitute(\_ _ {table} {sidewaystable}) addnote("\textbf{Regression equation:} \(g_{it} = \alpha  + \omega_i + \gamma_t + \beta \big(\log (\frac{\textrm{cgdpo}_{it}}{\textrm{pop}_{it}} ) - \log (\frac{\textrm{cgdpo}_{USA,t}}{\textrm{pop}_{USA,t}}  ) \big) + \epsilon_{it}\)" "Estimated values of \(\omega_i\) for each country \(i\) shown above.") wrap style(tex) title(Statistical significance of LAC individual country growth gaps (Non-LAC Benchmark)) booktabs b(a2) 
*tex3pt "figures/tables/sec2_mainReg_LACCountryDummies_rollingWindows.tex" using "figures/tables/sec2_mainReg_LACCountryDummies_fixed_rollingWindows.tex", fontsize(\footnotesize)
...
esttab using "figures/tables/sec3_mainReg_LACCountryDummies_giniSquared_rollingWindows.tex", label star(* 0.1 ** 0.05 *** 0.01) replace compress drop(*year) nobaselevels nogaps not noparentheses substitute(\_ _ {table} {sidewaystable}) addnote("\textbf{Regression equation:} \(g_{it} = \alpha  + \omega_i + \gamma_t + \beta \big(\log (\frac{\textrm{cgdpo}_{it}}{\textrm{pop}_{it}} ) - \log (\frac{\textrm{cgdpo}_{USA,t}}{\textrm{pop}_{USA,t}}  ) \big) + \epsilon_{it}\)" "Estimated values of \(\omega_i\) for each country \(i\) shown above.") wrap style(tex) title(Statistical significance of LAC individual country growth gaps (Non-LAC Benchmark)) booktabs b(a2) 
*tex3pt "figures/tables/sec2_mainReg_LACCountryDummies_rollingWindows.tex" using "figures/tables/sec2_mainReg_LACCountryDummies_fixed_rollingWindows.tex", fontsize(\footnotesize)
